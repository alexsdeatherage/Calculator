...
function getHoroscope(){
  ...
  if ((day < 0) || (month === 'april' && day > 31) || (month === 'june' && day > 31) || (month === 'september' && day > 31) || (month = 'november' && day > 31) || (month === 'february' & day > 28)) {
    ...
    flavorText.innerHTML = 'Please make sure that your birthday is inputted as the full month, and that the day is a valid number'
  }
}
